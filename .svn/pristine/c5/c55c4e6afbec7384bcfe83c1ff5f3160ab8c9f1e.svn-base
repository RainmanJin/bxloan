					...
					<form class="form-horizontal" id="form-cwxx">
						<div class="form-group">
							<label class="col-xs-12 col-sm-2 control-label no-padding-right">
								本地房产情况<font color="red">*</font> 
							</label>
							<div class="col-xs-12 col-sm-3">
								<span class="block input-icon input-icon-right">
									<select name="localHouseCondition" id="localHouseCondition" class="form-control"
									onchange="houseConditionChange(this)">
						...
						<div class="form-group">
							...
							<div class="col-xs-12 col-sm-3">
								<span class="block input-icon input-icon-right">
									<select name="carCondition" id="carCondition" class="form-control" onchange="carConditionChange(this)">
										<dd:options codeType="CommonWhether" />
									</select>
								</span>
							</div>
						...
						<div class="form-group">
							<label class="col-xs-12 col-sm-2 control-label no-padding-right">
								月还款额<font color="red">*</font> 
							</label>
							<div class="col-xs-12 col-sm-3">
								<span class="block input-icon input-icon-right">
								<div class="input-group">
									<input type="text" id="repaymentMonth" name="repaymentMonth" class="width-100 formatNum"/>
								  <span class="input-group-addon">元</span>
								 </div>
								</span>
							</div>
						...
						<div class="form-group">
							<label class="col-xs-12 col-sm-2 control-label no-padding-right">
								最高额度贷款行<font color="red">*</font> 
							</label>
							<div class="col-xs-12 col-sm-3">
								<span class="block input-icon input-icon-right">
									<input type="text" id="highestLoanBank" name="highestLoanBank" class="width-100"/>
								</span>
							</div>
							<div class="help-block col-xs-12 col-sm-reset inline">
							</div>
						...
						<div class="wizard-actions" style=" text-align:center;">
							<hr/>
							<span id="cwxxSpan">
								<button class="btn btn-sm btn-primary" id="saveJYCW" type="submit" data-loading-text="正在保存">
