...
<div id="customerTableDiv" style="display: none;">
	<div class="row">
		<form class="form-inline">
			   <label class="sr-only" for="customerNameForBail"></label> 
			         客户名称：<input type="text" class="form-control" id="customerNameForBail"
				style="width: 12%;"> 
				<label class="sr-only"for="customerNumForBail"></label> 
				客户编号：<input type="text"class="form-control" id="customerNumForBail" style="width: 12%;">
			    <label class="sr-only" for="certificateTypeCdForBail"></label> 
			          证件类型：
			...
			<div class="modal-content">
				...
				<form id="bailForm" class="form-horizontal">
					...
					<div class="modal-footer">
						<button id="sureBailForm" type="submit" class="btn btn-primary" data-loading-text="正在保存中...">确定</button>
