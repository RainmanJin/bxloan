...
public class WorkDraft implements java.io.Serializable {

	// Fields

	private Long workPapeId;
	...
	/** minimal constructor */
	public WorkDraft(Long workPapeId) {
		this.workPapeId = workPapeId;
	}

	/** full constructor */
	public WorkDraft(Long workPapeId, Long projectId,
	...
	public Long getWorkPapeId() {
		return this.workPapeId;
	}

	public void setWorkPapeId(Long workPapeId) {
		this.workPapeId = workPapeId;
	}

	@Column(name = "PROJECT_ID", precision = 20, scale = 0,nullable = false)
