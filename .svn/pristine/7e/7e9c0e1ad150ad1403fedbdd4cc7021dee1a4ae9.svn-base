...
@Entity
@Table(name = "REPAYING_PLAN_HISTORY", schema = WD_SCHEMA)
public class RepayingPlanHistory implements Serializable {
	...
	@EmbeddedId
	private RepayingPlanHistoryPk rphPk;
	...
	public RepayingPlanHistoryPk getRphPk() {
		return rphPk;
	}
	public void setRphPk(RepayingPlanHistoryPk rphPk) {
		this.rphPk = rphPk;
	}
}
