...
<%@include file="../../../../commons/taglibs.jsp"%>
	...
	<div>
		<div>
			<table id="tbCoborrower" class="table table-striped table-hover" style="width: 100%!important;">
				<thead>
					<tr>
						<th>
							选择
...
<!-- 配偶信息 -->
<div id="modal-formLxr" class="modal" data-backdrop="static"
	tabindex="-1">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="form-familyFriend" class="form-horizontal">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">
						&times;</button>
					<h4 class="blue bigger">配偶信息</h4>
				</div>
