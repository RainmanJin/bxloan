...
<%@ page import="com.coamctech.bxloan.web.security.ShiroUser" %>
...
<div class="navbar-container" id="navbar-container">
	...
	<div class="navbar-header pull-left">
		<a href="${ctx}" class="navbar-brand" style="pasition:absolute;margin-top:-13px;height: 58px">
			<img src="${res}/images/logo-dfbx-main.png"/><small>微贷业务系统
				</small> 
		</a>
	</div>
		...
		<ul class="nav ace-nav">
			<li class="light-blue">
				<a href="#">
					...
					<shiro:principal property="logOrgname"/>
				</a>
			</li>
			<!-- 
			<li class="grey">
			...
			<li class="light-blue">
				<a data-toggle="dropdown" href="#" class="dropdown-toggle">
					<img class="nav-user-photo" src="${ctx}/static/assets/avatars/avatar2.png" alt="Jason's Photo" />
				...
				<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
					...
					<% } %>
					<li>
						<a href="${ctx }/dashboard/personInfo">
							<i class="ace-icon fa fa-user"></i>
							个人资料
						</a>
					</li>
