 ...
 */
@Entity
@Table(name = "ARREARS_DETAIL_HISTORY",schema=WD_SCHEMA)
public class ArrearsDetailHistory implements Serializable {
	...
	@EmbeddedId
	private ArrearsDetailHistoryPk adhPk;
	...
	public ArrearsDetailHistoryPk getAdhPk() {
		return adhPk;
	}
	public void setAdhPk(ArrearsDetailHistoryPk adhPk) {
		this.adhPk = adhPk;
	}
