 ...
 */
@Entity
@Table(name = "REPAYING_DETAIL_HISTORY", schema = WD_SCHEMA)
public class RepayingDetailHistory implements Serializable {
	...
	@EmbeddedId
	private RepayingDetailHistoryPk rdhPk;
	...
	public RepayingDetailHistoryPk getRdhPk() {
		return rdhPk;
	}
	public void setRdhPk(RepayingDetailHistoryPk rdhPk) {
		this.rdhPk = rdhPk;
	}
