 ...
 */
@Entity
@Table(name = "REPAYING_PLAN_DETAIL_HISTORY", schema = WD_SCHEMA)
public class RepayingPlanDetailHistory implements Serializable {
	...
	@EmbeddedId
	private RepayingPlanDetailHistoryPk rpdhPk;
	...
	public RepayingPlanDetailHistoryPk getRpdhPk() {
		return rpdhPk;
	}
	public void setRpdhPk(RepayingPlanDetailHistoryPk rpdhPk) {
		this.rpdhPk = rpdhPk;
	}
