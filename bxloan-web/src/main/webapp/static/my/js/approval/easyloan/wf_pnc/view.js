	...
	var utils = require("utils");
	 var view = Backbone.View.extend({
            ...
            events :{
            	...
            	//"click #btn_doc_upload" : "uploadCommentFile"
            },
            initialize : function (){
                /** 初始化 */
            ...
            initApprSteps:function(){
            	var fnApprStep1=function(){
            		$(".appr_step2").slideUp();
            		$(".appr_step2_btn").hide();
                	$(".appr_step1").slideDown();
                	$(".appr_step1_btn").show();
            	}
            	var fnApprStep2=function(){
            		$(".appr_step1").slideUp();
            		$(".appr_step1_btn").hide();
            		$(".appr_step2").slideDown();
            		$(".appr_step2_btn").show();
            	}
            	$(document).on("click","button[role='nextStep']",function(){//下一步
            		fnApprStep2();
            	});
            	$(document).on("click","button[role='prevStep']",function(){//上一步
            		fnApprStep1();
            	})
            },
            sureAssigner:function(){
            	var viewSelf=this;
            ...
            submitProjAppl:function(){
            	...
            	//验证意见文档是否上传
            	viewSelf.model.checkUploadFile($("#projectId").val(),"S51",function(r_data){
            		if (r_data.success) {
            			//选择分配人
            			...
            			utils.alert.warn("必须上传<font color='red'>电核、网核审查意见表</font>，请确认！");
