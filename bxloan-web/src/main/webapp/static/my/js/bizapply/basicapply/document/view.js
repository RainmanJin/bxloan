...
define(function(require, exports, module) {
	...
	var view = Backbone.View.extend({
		  ...
		  downloadBtnLiveWd: function() {
            ...
            $(document).on("click", "button[role='download_wd']", function(e) {
            	 ...
            	 $.ajax({
                     cache: true,
                     type: "POST",
                     url: $$ctx + "bizapply/findDocumentPath",
                ...
                if (bootbox.confirm({
                    ...
                    callback: function(result) {
                        if (result) {
                            var id = $this.data("id");
                            $.ajax({
                                url: $$ctx + 'bizapply/delDocument/' + id,
                                dataType: 'HTML',
                                type: 'POST',
                                success: function(data) {
                                    if (data == "success") {
		...
		initDataTablesForDI: function() {
            ...
            var docsListTbURL=$$ctx + (viewSelf.jumpSource&&viewSelf.jumpSource=='taskDone'?"contractMng/findDocuments":"bizapply/findDocuments");
            ...
            function(dataDict) {
                var oTable = $("#tbWd").dataTable({
                    //"sAjaxSource":  $$ctx + "bizapply/findDocuments",
                    ...
                    "fnDrawCallback": function (oSettings) {
                    	 utils.upload.refreshSelectorTable("bizapply/findDocumentCustDocTypes", {
         					"partyId" : $("#partyId").val(),
