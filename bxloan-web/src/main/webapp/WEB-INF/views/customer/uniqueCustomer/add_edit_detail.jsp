	...
	<%@include file="../../../commons/taglibs.jsp" %>
		...
		<html lang="zh">
			<head>
				...
				<style type="text/css">
				 #projectFinace_modal div.modal-dialog {
				width: 800px;
				margin: 30px auto;
		        }
				</style>
			...
			<body class="no-skin" onunload="javascript: window.returnValue='modal';">
								...
								<div class="tabbable">
									...
									<div class="tab-content no-border padding-24">
										...
										<div>
											...
											/>
											<input type="hidden" id="hiddenForFamilyCertificateType" />
										...
										<div id="faq-tab-1" class="tab-pane fade in active">
											<jsp:include page="details/basicInfo_sx.jsp"></jsp:include>
										</div>
										<!-- 账户管理 -->
										<div id="faq-tab-2" class="tab-pane fade">
											<jsp:include page="details/accountList.jsp"></jsp:include>
										</div>
										<!-- 简要财务信息 -->
										<div id="faq-tab-3" class="tab-pane fade">
											<jsp:include page="details/familyFinance.jsp"></jsp:include>
										</div>
										<!-- 联系人管理 -->
										<div id="faq-tab-4" class="tab-pane fade">
											<jsp:include page="details/relativesList_sx.jsp"></jsp:include>
										</div>
										<!-- 文档资料管理 -->
										...
										<div id="faq-tab-7" class="tab-pane fade">
											<jsp:include page="../cusmanager/cusmanager.jsp"></jsp:include>
										</div>
									</div>
								</div>
							</div>
				...
				<script type="text/javascript" src="${my}/js/customer/uniqueCustomer/add_edit_detail/format.js">
				</script>
				<script>
					seajs.use('${my}/js/customer/uniqueCustomer/add_edit_detail/main');
				</script>
			</body>
