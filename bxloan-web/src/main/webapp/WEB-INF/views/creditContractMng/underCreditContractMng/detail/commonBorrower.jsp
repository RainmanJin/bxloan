	...
	<div class="row">
		<div class="col-md-12">
			<form class="form-inline">
				...
				客户名称：<input type="text" class="form-control"id="customerNameForCommonBorrower"> 
					
				<label class="sr-only"for="customerNumForCommonBorrower"></label> 
				客户编号：<input type="text" class="form-control" id="customerNumForCommonBorrower"> 
				
				<label class="sr-only" for="certificateTypeCdForCommonBorrower"></label>
				证件类型： <select id="certificateTypeCdForCommonBorrower"style="width: 162px;height: 34px;">
					      <dd:options codeType="CertificateType" /></select> 
				<label class="sr-only" for="certificateNumForCommonBorrower"></label>
				证件号码：<input type="text" class="form-control" id="certificateNumForCommonBorrower">

				<button type="button" class="btn btn-sm btn-purple" id="searchForCommonBorrower">
					<i class="ace-icon fa fa-search"></i>查询
				</button>
				<button type="button" class="btn btn-sm btn-warning" id="resetForCommonBorrower">
