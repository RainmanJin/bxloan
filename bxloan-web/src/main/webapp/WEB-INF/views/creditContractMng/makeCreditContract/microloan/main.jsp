...
<body class="no-skin">
     ...
     <div class="main-container" id="main-container">
             ...
             <div class="page-content">
                <div class="ace-settings-container" id="ace-settings-container">
                 ...
                 <!-- /.page-header -->
                  <!-- 隐藏域 -->
                 <div>
                       <input type="hidden" name="creditContractIdField" id="creditContractIdField" value="${creditContractId}" />
                       <input type="hidden" name="projectIdField" id="projectIdField"  value="${projectId}" />
                       <input type="hidden" name="projectNoField" id="projectNoField" value="${projectNo}" />
                       <input type="hidden" name="wfCodeField" id="wfCodeField" value="${wfCode}" />
                         ...
                         <div class="tabbable">
                             ...
                             <div class="tab-content no-border padding-24">
								...
								<div id="tab-1" class="tab-pane fade in active">
									<jsp:include page="creditContract.jsp" />
								</div>
                                ...
                                <div class="modal-dialog modal-full" style="display: inline-block; width: 1100px; ">
                                    <div class="modal-content">
	                                   	<!-- <div class="modal-header">
											<h4 class="modal-title" align="center"><span role="modal-title" id="td_name"></span></h4>
										</div> --> 
										<div class="modal-body">
											<iframe src="" name="mainFrame" id="mainFrame"  width="100%"  frameborder="0" marginheight="0" marginwidth="0" scrolling-x="no" > 
											</iframe>
										</div>
       ...
       <script>
           seajs.use('${ctx}/static/my/js/creditContractMng/makeCreditContract/microloan/main/main');
       </script>
 </body>
</html>