...
<body class="no-skin">
	...
	<div class="main-content">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					数据报送
					<small><i class="ace-icon fa fa-angle-double-right"></i> 上海金融办</small>
				</h1>
			</div>
			...
			<div style="height: 0px;" class="row">
				<div class="col-xs-12">
				   <form role="dataexport_form" id ="dataexport_form" class="form-horizontal">
						<!-- <div class="form-group"> -->
							<label class="control-label col-sm-1">开始日期：</label>
							<div class="form-group col-sm-2">
								<span class="block input-icon input-icon-right">
									<div class="input-group">
										<input type="text" class="form-control startTime input-sm" id="startTime" name="startTime" placeholder="开始日期" data-date-format="yyyy-mm-dd" >
									</div>
								</span>
							</div>
							...
							<div class="form-group  col-sm-2">
								<span class="block input-icon input-icon-right">
									<div class="input-group">
										<input type="text" class="form-control endTime input-sm" id="endTime" name="endTime" placeholder="结束日期" data-date-format="yyyy-mm-dd" >
									</div>
								</span>
							</div>
						<!-- </div> -->
				...
				<div class="col-md-12">
					<h3 class="smaller lighter blue">
						<span style="float:right">
							...
							<button class="btn btn-sm btn-success" id="btn-data-export" data-loading-text="正在保存中..." style="">
								<i class="ace-icon fa fa-arrow-down"></i> 数据导出
	                 		</button>
	                 	</span>
					</h3>
					<h3 class="blue" style="margin-left: 10px;">
					数据导出操作记录
					</h3>
					<table id="recordTable" class="table table-striped table-hover">
						<thead>
							<tr>
								<th><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>开始日期</th>
								<th><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>结束日期</th>
								<th>操作人</th>
								<th>操作人机构</th>
								<th><i class="ace-icon fa fa-clock-o bigger-110 hidden-480"></i>操作时间</th>
							</tr>
						</thead>
					</table>
				</div>
	...
	<script>
		seajs.use('${ctx}/static/my/js/datatransend/main');
	</script>
</body>
</html>
