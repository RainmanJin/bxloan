				...
				<head>
					...
					<body class="no-skin">
						...
						<div class="main-container" id="main-container">
							...
							<!-- add by HWL 20150811 start  团结贷标示 -->
							<input type="hidden" id="unityLoanProductMark" value="${unityLoanProductMark}">
							<!-- add by HWL 20150811  end-->
							<!-- -->
								...
								<div class="page-content">
									<div class="ace-settings-container" id="ace-settings-container">
										...
										<div class="ace-settings-box clearfix" id="ace-settings-box">
											<div class="pull-left width-50">
												...
												<c:if test="${taskStageCode eq '100413' or taskStageCode eq '100414' or taskStageCode eq '100415' or taskStageCode eq '100416' }">
													<div class="ace-settings-item">
														<label class="lbl" for="ace-settings-breadcrumbs">
										...
										<div class="col-xs-12">
											...
											<div id="timeline-2">
												<div class="row">
															...
															<div class="timeline-items">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100410" class="green bolder">
																					业务申请
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent" style="cursor:pointer;">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100411" class="green bolder">
																					贷款审查
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent" style="cursor:pointer;">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100412" class="green bolder">
																					初审环节
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100413" class="green bolder">
																					任务分配
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent" style="cursor:pointer;">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100414" class="green bolder">
																					一级审批
																				</span>
																			</div>
																		</div>
																...
																<div class="widget-body">
																<div class="widget-main no-padding">
																<span taskTypeId="100415"
																class="green bolder">任务分配</span>
																</div>
																</div>
																</div>
																</div> -->
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent" style="cursor:pointer;">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100416" class="green bolder">
																					二级审批
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100417" class="green bolder">
																					签订合同
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100418" class="green bolder">
																					总经理审核合同
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100419" class="green bolder">
																					落实贷款条件
																				</span>
																			</div>
																		</div>
																...
																<div class="timeline-item clearfix">
																	...
																	<div class="widget-box transparent">
																		<div class="widget-body">
																			<div class="widget-main no-padding">
																				<span taskTypeId="100420" class="green bolder">
																					审核贷款条件
																				</span>
																			</div>
																		</div>
													...
													<!-- /.timeline-items -->
													<div class="step-content pos-rel col-md-8" id="step-container">
														<div class="active">
															...
															<form class="form-horizontal" id="sample-form">
																...
																<div class="row">
																	...
																	<div class="form-group-wdapproval form-group">
																		<label for="inputError2" class="col-xs-12 col-sm-4 control-label no-padding-right">
																			<c:if test="${taskStageCode<'100417'}">
																				申报金额：
																			</c:if>
																			<c:if test="${taskStageCode>'100417'}">
																				贷款金额：
																...
																<div class="row">
																	...
																	<div class="form-group-wdapproval form-group">
																		...
																		<div class="col-xs-12 col-sm-8">
																			<span class="block input-icon input-icon-right">
																				<input value="${approvalContent.repayMode }" disabled="disabled" type="text"
																...
																<c:if test="${taskStageCode!='100411'&&taskStageCode!='100412'&&taskStageCode!='100414'&&taskStageCode!='100416'&&taskStageCode!='100415'}">
																<div class="row">
																	<div class="form-group-wdapproval form-group">
																...
																<div id="tableDiv">
																<c:if test="${taskStageCode!='100413'&&taskStageCode!='100418'&&taskStageCode!='100419'&&taskStageCode!='100420'}">
												...
												<!-- ----------------电话审查情况明细 ------------------>
												<c:if test="${taskStageCode=='100411'&&unityLoanProductMark}">
													<jsp:include page="main/phoneInfo.jsp"></jsp:include>
												</c:if>
												<!-- /.timeline-container -->
												<hr>
												<div class="wizard-actions" style=" text-align:center;">
													<c:if test="${taskStageCode=='100411'||taskStageCode=='100412' }">
													...
													<c:if test="${taskStageCode=='100419' }">
														<button class="btn btn-info" role="uploadCommentFile" data-loading-text="正在提交..">
															<i class="ace-icon fa fa-upload">
															</i>
															上传扫描件
													...
													<c:if test="${showContract and taskStageCode!='100412'}">
													...
													<c:if test="${taskStageCode!='100415' }">
													...
													<c:if test="${taskStageCode!='100413' and taskStageCode!='100418' and taskStageCode!='100419' and taskStageCode!='100420'}">
									...
									<%--审批意见 --%>
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<div>
															<select id="selectAssignerName" class="form-control">
															</select>
														</div>
														<div class="modal-footer" style="background-color:#fff!important;">
															<button id="select_assigner_sure" data-loading-text="正在提交..." class="btn btn-sm btn-primary">
										...
										<%--审批意见 --%>
											...
											<!-- 相关文档的模式窗口 END-->
											<!-- 查看历代批复信息 START -->
											<div id="showApprovals" class="modal fade" data-backdrop="static">
							...
							<script>
								seajs.use('${ctx}/static/my/js/wdapproval/main');
							</script>
				</head>
				</body>
