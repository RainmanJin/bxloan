...
public class FileUtils extends org.apache.commons.io.FileUtils{
     ...
     * @throws IOException
     */
    public static  void downloadExportFile(String fileName,HttpServletRequest request,HttpServletResponse response) throws IOException{
		...
		downloadFile(file, fileName, request, response);
		//下载后删除服务器文件
		file.delete();
    }
    ...
    public static void main(String[] args){
    	String EXCEL_TPL_PATH=StringUtils.join(ExcelUtils.getTemplatePath(),File.separator,"wd_contract_tpl.xlsx");
    	System.out.println(EXCEL_TPL_PATH);
    	System.out.println(getResourceAsStream(EXCEL_TPL_PATH));
    }
}
